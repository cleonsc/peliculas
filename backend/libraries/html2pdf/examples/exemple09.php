...
<html>
    <head>
        ...
        <title>Exemple d'auto g̩n̩ration de PDF</title>
    </head>
    <body>
<?php
}
...
?>
<br>
Ceci est un exemple de g̩n̩ration de PDF via un bouton :)<br>
<br>
...
<?php
    if ($generate) {
?>
Bonjour <b><?php echo $nom; ?></b>, ton nom peut s'̩crire : <br>
