...
<page style="font-size: 10pt">
    <span style="font-size: 16pt ; font-weight: bold">DÃ©monstration des images</span><br>
    <br>
    ...
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
            ...
            <td style="width: 40%; text-align: center;"><img src="./res/logo.gif" alt="" ><br><i>lÃ©gende</i></td>
    ...
    texte Ã  la suite d'une image, <img src="./res/logo.gif" alt="" style="height: 10mm">
