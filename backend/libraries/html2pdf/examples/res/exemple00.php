...
<page style="font-size: 14px">
    ...
    <br>
    Retours Ã  la ligne autorisÃ©s : &lt;br&gt;, &lt;br &gt;, &lt;br/&gt;, &lt;br /&gt; <br />
    <br>
        ...
        <tr>
            <td border="1">
                <table style="border: solid 1px #FF0000; background: #FFFFFF; width: 100%; text-align: center">
                    <tr>
                        <th style="border: solid 1px #007700;width: 50%">C1 â‚¬ Â«</th>
                        <td style="border: solid 1px #007700;width: 50%">C2 â‚¬ Â«</td>
                    </tr>
                    <tr>
