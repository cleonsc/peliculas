...
<page backcolor="#FEFEFE" backimg="./res/bas_page.png" backimgx="center" backimgy="bottom" backimgw="100%" backtop="0" backbottom="30mm" footer="date;heure;page" style="font-size: 12pt">
    ...
    <i>
        ...
        RÃ©fÃ©rence du Dossier : 71326<br>
    </i>
    <br>
    <br>
    ...
    <br>
    <br>
    Nous souhaitons vous informer que le dossier <b>71326</b> concernant un &laquo; Bon de Retour &raquo; pour les articles suivants a Ã©tÃ© acceptÃ©.<br>
    <br>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <th style="width: 12%">Produit</th>
            <th style="width: 52%">DÃ©signation</th>
...
?>
    ...
    <br>
    Cette reprise concerne la quantitÃ© et les matÃ©riels dont la rÃ©fÃ©rence figure sur le <a href="#document_reprise">document de reprise joint</a>.<br>
    Nous vous demandons de nous retourner ces produits en parfait Ã©tat et dans leur emballage d'origine.<br>
    <br>
    Nous vous demandons Ã©galement de coller impÃ©rativement l'autorisation de reprise jointe, sur le colis Ã  reprendre afin de faciliter le traitement Ã  l'entrepÃ´t.<br>
    <br>
    Notre Service Clients ne manquera pas de revenir vers vous dÃ¨s que l'avoir de ces matÃ©riels sera Ã©tabli.<br>
    <nobreak>
        <br>
