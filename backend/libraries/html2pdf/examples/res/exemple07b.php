        ...
        <tr>
            ...
            <td style="width: 37% ">
                <table cellspacing="0" style="width: 100%; border: solid 2px #000000; font-size: 12pt;">
                    <tr><td style="width: 40%;">RÃ©fÃ©rence :        </td><td style="width: 60%;">71326</td></tr>
                    <tr><td style="width: 40%;">Client :        </td><td style="width: 60%;">M. Albert Dupont</td></tr>
                    <tr><td style="width: 40%;">Adresse :        </td><td style="width: 60%;">RÃ©sidence perdue<br>1, rue sans nom<br>00 000 - Pas de Ville</td></tr>
                ...
                <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
                    <tr>
                        <th style="width: 100%; text-align: center; border: solid 1px #000000;" colspan="4">
                            Partie rÃ©servÃ©e Ã  Spipu Corp
                        </th>
                    </tr>
                    <tr>
                        <th style="width: 100%; text-align: center; border: solid 1px #000000;" colspan="4">
                    ...
                    <tr>
                        ...
                        <th style="width: 15%; border: solid 1px #000000;">AbÃ®mÃ©</th>
                    </tr>
<?php
$i=0;
                ...
                <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
                    <tr>
                        <th style="width: 100%; text-align: center; border: solid 1px #000000;" colspan="2">
                            Partie rÃ©servÃ©e Ã  l'entrepÃ´t
                        </th>
                    </tr>
                    <tr>
                        <th style="width: 100%; text-align: center; border: solid 1px #000000;" colspan="2">
                    ...
                    <tr>
                        ...
                        <th style="width: 50%; border: solid 1px #000000;">Produit Ã  reconditionner    </th>
                    </tr>
<?php
    for ($i=0; $i<12; $i++) {
?>
