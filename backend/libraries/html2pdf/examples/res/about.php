...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <br><br><br><br><br>
    <div class="note">
        HTML2PDF est un convertisseur de code HTML vers PDF Ã©crit en PHP5, utilisant la librairie <a href="http://tcpdf.org">TCPDF.</a><br>
        <br>
        Il permet la conversion d'HTML et d'xHTML valide au format PDF, et est distribuÃ© sous licence LGPL.<br>
        <br>
        Cette librairie a Ã©tÃ© conÃ§ue pour gÃ©rer principalement les TABLE imbriquÃ©es afin de gÃ©nÃ©rer des factures, bon de livraison, et autres documents officiels.<br>
        <br>
        Vous pouvez tÃ©lÃ©charger la derniÃ¨re version de HTML2PDF ici : <a href="http://html2pdf.fr/">http://html2pdf.fr/</a>.<br>
    </div>
</page>
<page pageset="old">
...
<page pageset="old">
    <bookmark title="CompatibilitÃ©" level="0" ></bookmark>
    ...
    <ul class="main">
        ...
        <li>&lt;br&gt; : Permet d'aller Ã  la ligne</li>
    ...
    <bookmark title="Balises spÃ©cifiques" level="2" ></bookmark>
    <div class="note">
        Les balises spÃ©cifiques suivantes ont Ã©tÃ© ajoutÃ©es :<br>
    </div>
    <br>
    <ul class="main" >
        <li>&lt;page&gt;</li>
...
<page pageset="old">
    <bookmark title="PropriÃ©tÃ©s" level="1" ></bookmark>
    <div class="note">
        La liste des propriÃ©tÃ©s utilisables est la suivante :<br>
    </div>
    <br>
    <table style="width: 100%">
        <tr style="vertical-align: top">
    ...
    <br>
    <ul class="main">
        <li>Les float ne sont gÃ©rÃ©s que pour la balise IMG.</li>
        <li>Elle ne permet gÃ©nÃ©ralement pas la conversion directe d'une page HTML en PDF, ni la conversion du rÃ©sultat d'un WYSIWYG en PDF.</li>
        <li>Cette librairie est lÃ  pour faciliter la gÃ©nÃ©ration de documents PDF, pas pour convertir n'importe quelle page HTML.</li>
