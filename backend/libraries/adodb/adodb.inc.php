...
*/
	...
	*/
	...
	function Connect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $forceNew = false) 
	{
		...
		if ($forceNew) {
			if ($rez=$this->_nconnect($this->host, $this->user, $argPassword, $this->database)) return false;//return true;
		} else {
			 if ($rez=$this->_connect($this->host, $this->user, $argPassword, $this->database)) return false;//return true;
		}
		if (isset($rez)) {
			$err = $this->ErrorMsg();
